...
for(var i = 0; i < 5; i++){
  ...
  midway.abilities.add(new UnitSpawnAbility(UnitTypes.horizon, 60 * 30, 0, 15 - i * 7.5));
  midway.abilities.add(new UnitSpawnAbility(UnitTypes.flare, 60 * 30, -7.50, 15 - i * 7.5));
}
